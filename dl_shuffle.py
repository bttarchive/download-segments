            ...
            try:
                ...
                try:
                    if (substring1 in link) and (substring2 in link):
                        ...
                        with YoutubeDL(ydl_opts) as ydl:
                            ydl.download('http://localhost/' + str([lines[i][0]])[2:-2].replace(
                                "https://media.discordapp.net/", "").replace("https://cdn.discordapp.com/", ""))
