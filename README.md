...
IMPORTANT: If your list of links contains ANY `cdn.discordapp.com/...`-links, download [this script](https://raw.githubusercontent.com/bttarchive/download-segments/main/dl_shuffle.py) instead.
